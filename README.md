...
**Dependabot:** config on `main` with `target-branch: storybook` — PRs only into **storybook**, never into `main`. Weekly grouped npm + Actions; patch/minor auto-merge waits for required CI/reviews.
