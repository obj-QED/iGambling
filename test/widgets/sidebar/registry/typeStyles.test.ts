...
describe('resolveSidebarTypePack styles', () => {
  it('resolves compact, default, slideout, and slidein modules', () => {
    ...
    expect(TYPE_PACK_REGISTRY.slidein.styles.root).toBeTruthy();
    ...
    expect(resolveSidebarTypePack('slidein').styles.root).toBe(
      TYPE_PACK_REGISTRY.slidein.styles.root,
    );
  });
