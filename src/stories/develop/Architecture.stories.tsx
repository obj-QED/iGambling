...
import {
  DEVELOP_FORBIDDEN,
  DEVELOP_HEADER_PIPELINE,
  DEVELOP_PLATFORM_PIPELINE,
  DEVELOP_SEPARATION_ROWS,
} from './content';
import {
  DevelopBulletList,
  DevelopCode,
  ...
  render: () => (
    <DevelopDocPage
      ...
      sections={[
        ...
        {
          id: 'header-today',
          title: 'Header — what exists on disk',
          body: <DevelopCode>{DEVELOP_HEADER_PIPELINE}</DevelopCode>,
        },
        {
          id: 'separation',
